...
type ClusterHaResourcesCreateResponse struct{}

// Create a new HA resource.
// https://pve.proxmox.com/pve-docs/api-viewer/#/cluster/ha/resources
func (c *Client) ClusterHaResourcesCreate(ctx context.Context, request *ClusterHaResourcesCreateRequest) (*ClusterHaResourcesCreateResponse, error) {

	method := "POST"
	path := "/cluster/ha/resources"

	var response ClusterHaResourcesCreateResponse
