...
func (c *Client) NodesNetworkUpdateNetwork(ctx context.Context, request *NodesNetworkUpdateNetworkRequest) (*NodesNetworkUpdateNetworkResponse, error) {

	method := "PUT"
	path := "/nodes/{node}/network/{iface}"

	var response NodesNetworkUpdateNetworkResponse
