...
type ClusterFirewallGroupsUpdateRuleResponse struct{}

// Modify rule data.
// https://pve.proxmox.com/pve-docs/api-viewer/#/cluster/firewall/groups/{group}/{pos}
func (c *Client) ClusterFirewallGroupsUpdateRule(ctx context.Context, request *ClusterFirewallGroupsUpdateRuleRequest) (*ClusterFirewallGroupsUpdateRuleResponse, error) {

	method := "PUT"
	path := "/cluster/firewall/groups/{group}/{pos}"

	var response ClusterFirewallGroupsUpdateRuleResponse
