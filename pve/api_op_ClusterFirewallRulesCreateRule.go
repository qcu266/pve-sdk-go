...
type ClusterFirewallRulesCreateRuleResponse struct{}

// Create new rule.
// https://pve.proxmox.com/pve-docs/api-viewer/#/cluster/firewall/rules
func (c *Client) ClusterFirewallRulesCreateRule(ctx context.Context, request *ClusterFirewallRulesCreateRuleRequest) (*ClusterFirewallRulesCreateRuleResponse, error) {

	method := "POST"
	path := "/cluster/firewall/rules"

	var response ClusterFirewallRulesCreateRuleResponse
