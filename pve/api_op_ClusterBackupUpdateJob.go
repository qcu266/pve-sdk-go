...
func (c *Client) ClusterBackupUpdateJob(ctx context.Context, request *ClusterBackupUpdateJobRequest) (*ClusterBackupUpdateJobResponse, error) {

	method := "PUT"
	path := "/cluster/backup/{id}"

	var response ClusterBackupUpdateJobResponse
