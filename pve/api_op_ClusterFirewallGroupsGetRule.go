...
func (c *Client) ClusterFirewallGroupsGetRule(ctx context.Context, request *ClusterFirewallGroupsGetRuleRequest) (*ClusterFirewallGroupsGetRuleResponse, error) {

	method := "GET"
	path := "/cluster/firewall/groups/{group}/{pos}"

	var response ClusterFirewallGroupsGetRuleResponse
