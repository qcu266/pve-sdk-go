...
type NodesQemuFirewallOptionsSetOptionsRequest struct {
...
type NodesQemuFirewallOptionsSetOptionsResponse struct{}

// Set Firewall options.
// https://pve.proxmox.com/pve-docs/api-viewer/#/nodes/{node}/qemu/{vmid}/firewall/options
func (c *Client) NodesQemuFirewallOptionsSetOptions(ctx context.Context, request *NodesQemuFirewallOptionsSetOptionsRequest) (*NodesQemuFirewallOptionsSetOptionsResponse, error) {

	method := "PUT"
	path := "/nodes/{node}/qemu/{vmid}/firewall/options"

	var response NodesQemuFirewallOptionsSetOptionsResponse
