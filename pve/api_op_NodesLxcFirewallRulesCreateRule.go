...
type NodesLxcFirewallRulesCreateRuleResponse struct{}

// Create new rule.
// https://pve.proxmox.com/pve-docs/api-viewer/#/nodes/{node}/lxc/{vmid}/firewall/rules
func (c *Client) NodesLxcFirewallRulesCreateRule(ctx context.Context, request *NodesLxcFirewallRulesCreateRuleRequest) (*NodesLxcFirewallRulesCreateRuleResponse, error) {

	method := "POST"
	path := "/nodes/{node}/lxc/{vmid}/firewall/rules"

	var response NodesLxcFirewallRulesCreateRuleResponse
