...
type AccessDomainsCreateRequest struct {
	...
	Type                string  `json:"type,omitempty"`                  // Realm type.
	...
	UsernameClaim       *string `json:"username-claim,omitempty"`        // OpenID claim used to generate the unique username.
	Verify              *bool   `json:"verify,omitempty"`                // Verify the server's SSL certificate
}

type AccessDomainsCreateResponse struct{}

// Add an authentication server.
// https://pve.proxmox.com/pve-docs/api-viewer/#/access/domains
func (c *Client) AccessDomainsCreate(ctx context.Context, request *AccessDomainsCreateRequest) (*AccessDomainsCreateResponse, error) {

	method := "POST"
	path := "/access/domains"

	var response AccessDomainsCreateResponse
