...
type NodesLxcFirewallRulesUpdateRuleResponse struct{}

// Modify rule data.
// https://pve.proxmox.com/pve-docs/api-viewer/#/nodes/{node}/lxc/{vmid}/firewall/rules/{pos}
func (c *Client) NodesLxcFirewallRulesUpdateRule(ctx context.Context, request *NodesLxcFirewallRulesUpdateRuleRequest) (*NodesLxcFirewallRulesUpdateRuleResponse, error) {

	method := "PUT"
	path := "/nodes/{node}/lxc/{vmid}/firewall/rules/{pos}"

	var response NodesLxcFirewallRulesUpdateRuleResponse
