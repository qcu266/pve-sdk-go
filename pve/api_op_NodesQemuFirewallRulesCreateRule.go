...
type NodesQemuFirewallRulesCreateRuleResponse struct{}

// Create new rule.
// https://pve.proxmox.com/pve-docs/api-viewer/#/nodes/{node}/qemu/{vmid}/firewall/rules
func (c *Client) NodesQemuFirewallRulesCreateRule(ctx context.Context, request *NodesQemuFirewallRulesCreateRuleRequest) (*NodesQemuFirewallRulesCreateRuleResponse, error) {

	method := "POST"
	path := "/nodes/{node}/qemu/{vmid}/firewall/rules"

	var response NodesQemuFirewallRulesCreateRuleResponse
