...
type NodesQemuFirewallRulesUpdateRuleResponse struct{}

// Modify rule data.
// https://pve.proxmox.com/pve-docs/api-viewer/#/nodes/{node}/qemu/{vmid}/firewall/rules/{pos}
func (c *Client) NodesQemuFirewallRulesUpdateRule(ctx context.Context, request *NodesQemuFirewallRulesUpdateRuleRequest) (*NodesQemuFirewallRulesUpdateRuleResponse, error) {

	method := "PUT"
	path := "/nodes/{node}/qemu/{vmid}/firewall/rules/{pos}"

	var response NodesQemuFirewallRulesUpdateRuleResponse
