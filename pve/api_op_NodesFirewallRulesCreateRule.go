...
type NodesFirewallRulesCreateRuleResponse struct{}

// Create new rule.
// https://pve.proxmox.com/pve-docs/api-viewer/#/nodes/{node}/firewall/rules
func (c *Client) NodesFirewallRulesCreateRule(ctx context.Context, request *NodesFirewallRulesCreateRuleRequest) (*NodesFirewallRulesCreateRuleResponse, error) {

	method := "POST"
	path := "/nodes/{node}/firewall/rules"

	var response NodesFirewallRulesCreateRuleResponse
