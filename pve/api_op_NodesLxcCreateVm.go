...
type NodesLxcCreateVmRequest struct {
	...
	Force              *bool    `json:"force,omitempty"`                // Allow to overwrite existing container.
	...
	IgnoreUnpackErrors *bool    `json:"ignore-unpack-errors,omitempty"` // Ignore errors when extracting the template.
	...
	Ostemplate         string   `json:"ostemplate,omitempty"`           // The OS template or backup file.
	...
	Password           *string  `json:"password,omitempty"`             // Sets root password inside container.
	...
	Restore            *bool    `json:"restore,omitempty"`              // Mark this as restore task.
	...
	SshPublicKeys      *string  `json:"ssh-public-keys,omitempty"`      // Setup public SSH keys (one key per line, OpenSSH format).
	Start              *bool    `json:"start,omitempty"`                // Start the CT after its creation finished successfully.
...
type NodesLxcCreateVmResponse string

// Create or restore a container.
// https://pve.proxmox.com/pve-docs/api-viewer/#/nodes/{node}/lxc
func (c *Client) NodesLxcCreateVm(ctx context.Context, request *NodesLxcCreateVmRequest) (*NodesLxcCreateVmResponse, error) {

	method := "POST"
	path := "/nodes/{node}/lxc"

	var response NodesLxcCreateVmResponse
