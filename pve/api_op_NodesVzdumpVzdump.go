...
type NodesVzdumpVzdumpRequest struct {
	...
	Stdout           *bool   `json:"stdout,omitempty"`           // Write tar to stdout, not to a file.
...
type NodesVzdumpVzdumpResponse string

// Create backup.
// https://pve.proxmox.com/pve-docs/api-viewer/#/nodes/{node}/vzdump
func (c *Client) NodesVzdumpVzdump(ctx context.Context, request *NodesVzdumpVzdumpRequest) (*NodesVzdumpVzdumpResponse, error) {

	method := "POST"
	path := "/nodes/{node}/vzdump"

	var response NodesVzdumpVzdumpResponse
