...
type NodesLxcConfigUpdateVmResponse struct{}

// Set container options.
// https://pve.proxmox.com/pve-docs/api-viewer/#/nodes/{node}/lxc/{vmid}/config
func (c *Client) NodesLxcConfigUpdateVm(ctx context.Context, request *NodesLxcConfigUpdateVmRequest) (*NodesLxcConfigUpdateVmResponse, error) {

	method := "PUT"
	path := "/nodes/{node}/lxc/{vmid}/config"

	var response NodesLxcConfigUpdateVmResponse
