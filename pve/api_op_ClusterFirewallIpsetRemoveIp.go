...
type ClusterFirewallIpsetRemoveIpResponse struct{}

// Remove IP or Network from IPSet.
// https://pve.proxmox.com/pve-docs/api-viewer/#/cluster/firewall/ipset/{name}/{cidr}
func (c *Client) ClusterFirewallIpsetRemoveIp(ctx context.Context, request *ClusterFirewallIpsetRemoveIpRequest) (*ClusterFirewallIpsetRemoveIpResponse, error) {

	method := "DELETE"
	path := "/cluster/firewall/ipset/{name}/{cidr}"

	var response ClusterFirewallIpsetRemoveIpResponse
